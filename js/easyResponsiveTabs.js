...
(function($) {
    $.fn.extend({
        easyResponsiveTabs: function(options) {
            ...
            var tab_icons = new Array("fa fa-user icon_menu icon_menu_active", "fa fa-tasks icon_menu", "fa fa-briefcase icon_menu", "fa fa-flag icon_menu", "fa fa-bullhorn icon_menu", "fa fa-envelope icon_menu");
            var i = 1;
            this.each(function() {
